...
export default function Analyze() {
  ...
  const selectedTransactions =
    statements.find((s) => s._id === selectedStatementId)?.extractedTransactions || [];
...
//       ${section("Key Insights", result?.insights?.join(", "))}
//       ${section("Action Plan", result?.fixes?.join(", "))}
//       ${section("Financial Impact", result?.impact)}
